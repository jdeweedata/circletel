-- Coverage Provider Management System Enhancement
-- Phase 1: Enhance existing schema for full provider API management
-- Created: 2025-10-19
-- Status: Refactored to work with existing schema
...
-- =====================================================
-- Update provider_configuration table
-- Purpose: Add provider management settings to existing table
-- =====================================================
...
-- =====================================================
-- Enhance: fttb_network_providers table
-- Purpose: Add columns for health monitoring, SSO, and priority
-- =====================================================
...
-- Purpose: Move hardcoded MTN config from code to database
-- =====================================================
...
DO $$
BEGIN
  RAISE NOTICE 'Provider Management System Enhancement completed successfully';
  RAISE NOTICE 'Created tables: provider_api_logs';
  RAISE NOTICE 'Enhanced table: fttb_network_providers (added health columns, sso_config, priority)';
  RAISE NOTICE 'Updated table: provider_configuration (added provider management settings)';
  RAISE NOTICE 'Migrated MTN configs: MTN Wholesale, MTN Business WMS, MTN Consumer';
