import { PiArrowsClockwiseBold, PiDownloadSimpleBold, PiFunnelBold, PiGridFourBold, PiListBold, PiPlusBold, PiSlidersHorizontalBold } from 'react-icons/pi';
            ...
            <div className="flex items-center justify-between mt-3 pt-3 border-t border-slate-100">
                <div className="flex items-center gap-2 text-xs text-slate-400">
                    <button className="flex items-center gap-1 hover:text-slate-600">
                        <PiSlidersHorizontalBold size={12} />
                        Presets
                    </button>
            ...
            {Object.values(filteredGroups).flat().length === 0 && (
                <div className="flex flex-col items-center justify-center py-20 bg-white rounded-2xl border border-dashed border-slate-300">
                    <div className="w-16 h-16 bg-slate-50 rounded-full flex items-center justify-center mb-4">
                        <PiFunnelBold size={32} className="text-slate-300" />
                    </div>
