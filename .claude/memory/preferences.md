...
- Include scope when relevant: `feat(admin): add user management`
- Keep subject line under 72 characters

## Workflow

- Always run `npm run type-check:memory` before committing
- Test changes locally with `npm run dev:memory`
