      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="text-center p-6">
            ...
            <p className="text-circleTel-secondaryNeutral">
              Maintain operations during disruptions or office closures with anytime, anywhere access.
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 bg-circleTel-lightNeutral p-6 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white p-4 rounded-lg">
              <h4 className="font-bold text-center mb-2">Work From Anywhere</h4>
              <p className="text-sm text-center">
                Access your desktop from any location with internet - office, home, or on the go.
              </p>
            </div>
            <div className="bg-white p-4 rounded-lg">
