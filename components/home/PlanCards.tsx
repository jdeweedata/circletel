...
const HOME_PLANS: HeroPlan[] = [
  {
    ...
    badgeColor: 'orange',
    featured: true,
    features: ['Uncapped data', '99.5% uptime SLA', 'Month-to-month'],
  },
  {
    id: 'skyfibre-home-100',
    ...
    badge: 'Best Value',
    badgeColor: 'orange',
    features: ['Uncapped data', '99.7% uptime SLA', '3hr support response'],
  },
  {
    id: 'skyfibre-home-200',
    ...
    badge: 'Premium',
    badgeColor: 'blue',
    features: ['Uncapped data', '99.9% uptime SLA', 'Free install included'],
  },
  {
    id: 'home-lte-backup',
    name: 'LTE Backup',
    ...
    speed: 'LTE',
    type: 'lte',
    description: 'Reliable mobile backup when your primary line fails',
    badge: 'Add-on',
    badgeColor: 'green',
  },
];
