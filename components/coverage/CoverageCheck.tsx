  ...
  const handleCoverageCheck = async () => {
    ...
    try {
      ...
      if (!latitude || !longitude) {
        ...
        if (geocodeResult) {
          latitude = geocodeResult.latitude || geocodeResult.geometry.location.lat;
          longitude = geocodeResult.longitude || geocodeResult.geometry.location.lng;
      ...
      const result = await coverageApiService.checkCoverage(locationData.address);
