    ...
    <div className={cn("relative w-full", className)}>
      <div className="relative">
        ...
        <Input
          ...
          className={cn(
            "h-16 pl-12 pr-20 text-lg rounded-full bg-white/90 backdrop-blur-sm border-2 border-white/30 focus:border-white focus:bg-white text-circleTel-darkNeutral placeholder:text-circleTel-secondaryNeutral/70",
