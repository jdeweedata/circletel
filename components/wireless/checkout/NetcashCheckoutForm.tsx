import { PiBuildingsBold, PiCheckCircleBold, PiCreditCardBold, PiDeviceMobileBold, PiEyeBold, PiInfoBold, PiLockBold, PiShieldCheckBold, PiSpinnerBold } from 'react-icons/pi';
"use client"
