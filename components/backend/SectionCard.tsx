...
/**
 * Standard card-with-header for grouped content across backend UIs.
 * Promoted from components/admin/shared/SectionCard.tsx.
 */
    ...
    <div className={cn('bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm', className)}>
      <div className={cn('border-b border-gray-100 flex justify-between items-center', headerPadding)}>
        <div className="flex items-center gap-2">
          ...
          <h3 className={cn('font-bold text-gray-900', compact && 'text-sm')}>{title}</h3>
        </div>
        {action}
      </div>
