    ...
    return (
      <div className={`flex items-center justify-center gap-3 text-sm text-gray-600 ${className}`}>
        <div className="flex items-center gap-1.5">
          <PiLockBold className="w-4 h-4 text-green-600" />
          <span className="font-medium">Secure checkout</span>
        </div>
        <span className="text-gray-300">•</span>
        <div className="flex items-center gap-1.5">
          <PiShieldBold className="w-4 h-4 text-blue-600" />
      ...
      <div className={`space-y-3 ${className}`}>
        ...
        <div className="flex items-center justify-center gap-3 py-3 bg-gray-50 rounded-lg border border-gray-200">
          ...
          <div className="flex items-center gap-2">
            ...
            <PiCreditCardBold className="w-5 h-5 text-gray-400" />
          </div>
        </div>
    ...
    <div className={`bg-green-50 border border-green-200 rounded-lg p-4 ${className}`}>
      <div className="flex items-start gap-3">
        <div className="flex-shrink-0">
          <PiShieldBold className="w-5 h-5 text-green-600" />
        </div>
