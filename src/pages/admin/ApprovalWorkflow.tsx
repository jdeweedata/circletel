...
import { useApprovalsRealtime } from '@/hooks/useRealtimeSync'
...
export function ApprovalWorkflow() {
  const { data: realtimeApprovals, isLoading, error, refresh, lastUpdated } = useApprovalsRealtime(true)
  ...
  const approvals = realtimeApprovals.length > 0 ? realtimeApprovals : mockApprovals
