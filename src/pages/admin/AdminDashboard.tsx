...
import { useAdminStatsRealtime } from '@/hooks/useRealtimeSync'
...
export function AdminDashboard() {
  ...
  // Mock recent activity data for now - this would come from audit logs in a real implementation
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {quickActions.map((action, index) => (
              <Button
                ...
                className={`h-auto p-4 flex flex-col items-start space-y-2 ${action.color} text-white relative`}
