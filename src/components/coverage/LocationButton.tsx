    ...
    try {
      ...
      if (locationInfo) {
        onLocationSelect({
          ...
          street: locationInfo.addressComponents.route || '',
          streetNumber: locationInfo.addressComponents.streetNumber || '',
          town: locationInfo.addressComponents.locality || '',
          buildingComplex: '',
          postalCode: locationInfo.addressComponents.postalCode || '',
        });
      } else {
