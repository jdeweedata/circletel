      ...
      <main className="container mx-auto py-8 px-4 max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            Hi {invoice?.customer_first_name}, complete your payment securely below.
          </p>
        </div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="bg-muted/50 rounded-lg p-4 space-y-3">
              ...
              <div className="flex justify-between text-lg font-semibold">
                ...
                <span className="text-primary">{formatCurrency(invoice?.amount_due || 0)}</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 text-sm text-muted-foreground bg-green-50 dark:bg-green-950/20 rounded-lg p-4">
              ...
              <div>
                ...
                <p>
                  Your payment is processed securely through NetCash, a PCI-DSS compliant payment
            ...
            <div className="border rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm bg-muted/50 rounded p-3">
