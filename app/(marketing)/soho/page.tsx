...
const WORKCONNECT_PLANS: Plan[] = [
  ...
  },
  {
    ...
    speed: '200Mbps',
    type: '5g',
    description: 'Enterprise-grade for serious work',
    features: [
      '200/100 Mbps symmetric',
      'Multiple 4K streams',
      '100GB cloud backup',
      '10 email accounts',
      'Static IP included',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="font-body text-lg md:text-xl text-circleTel-grey600 mb-8 max-w-2xl mx-auto">
              ...
              From <span className="font-semibold text-circleTel-navy">R799/month</span>.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 md:p-12 border border-gray-100">
            ...
            <blockquote className="font-body text-xl md:text-2xl text-circleTel-navy italic mb-6 leading-relaxed">
              &ldquo;Finally, an ISP that understands remote work. Video calls never drop,
              even during load shedding with their 5G backup option. My productivity has
              never been better.&rdquo;
            </blockquote>
