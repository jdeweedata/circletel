...
export default function B2BVettingDetailPage({
  ...
  return (
    <>
      <main className="flex min-h-[calc(100vh-64px)] max-w-none flex-col bg-gray-50 px-4 py-4 lg:px-5">
      ...
      <section className="grid grid-cols-1 overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm xl:min-h-[680px] xl:flex-1 xl:grid-cols-[280px_minmax(0,1fr)_300px]">
                ...
                {!submission.nameMatch && (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={cn(
                          ...
                          isUnjani || mismatchAck ? 'text-amber-900' : 'text-red-700'
                        )}
                      >
                        {isUnjani
                    ...
                    {isUnjani ? (
                      ...
                      <>
                        <p className="mt-3 text-xs leading-5 text-amber-800">
                          The account holder differs from the registered entity. Acknowledge the
                          exception only when supporting evidence is clear.
                        </p>
                        <Button
                          size="sm"
