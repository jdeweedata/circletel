      ...
      <div className="text-center max-w-2xl">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          ...
          <div className="flex flex-wrap gap-4 justify-center text-sm">
            <Link href="/pricing" className="text-circleTel-orange hover:underline">
              Internet Packages
            </Link>
            <Link href="/order" className="text-circleTel-orange hover:underline">
              Check Coverage
            </Link>
            <Link href="/business" className="text-circleTel-orange hover:underline">
              Business Solutions
            </Link>
