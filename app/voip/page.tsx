...
export const metadata: Metadata = {
  title: 'VoIP Services | CircleTel',
  description: 'Affordable voice over IP services with flexible pricing and crystal-clear call quality.',
}
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-4xl">
              ...
              <p className="text-xl md:text-2xl text-white/95 max-w-2xl">
                Make affordable voice calls over your existing Internet connection. No landline needed.
              </p>
            </div>
          </div>
        </div>
