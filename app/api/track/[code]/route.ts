 ...
 * Public Tracking API
 *
 * GET /api/track/[code] - Track click and redirect to destination
 *
 * This endpoint handles tracking link clicks for ambassadors, partners, and campaigns.
 * It logs the click event and redirects to the destination URL.
 */
...
export async function GET(
  ...
  try {
    ...
    destinationUrl.searchParams.set('utm_source', 'ambassador');
    destinationUrl.searchParams.set('utm_medium', 'referral');
    destinationUrl.searchParams.set('utm_campaign', code.toUpperCase());
