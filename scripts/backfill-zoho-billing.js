 ...
 *
 * Usage:
 *   node scripts/backfill-zoho-billing.js
 *   node scripts/backfill-zoho-billing.js --dry-run
 *   node scripts/backfill-zoho-billing.js --filter=active
 *   node scripts/backfill-zoho-billing.js --limit=10
 */

import { createClient } from '@supabase/supabase-js';
import { syncServicePackageToZohoBilling } from '../lib/integrations/zoho/billing-sync-service.js';
 ...
 */
async function updateProductIntegrations(servicePackageId, billingResult) {
  if (isDryRun) {
