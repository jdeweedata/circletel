 ...
 *
 * Creates 19 consumer-friendly MTN packages:
 * - 3 x 5G Uncapped
 * - 5 x LTE Uncapped
...
const consumerPackages = [
  ...
  // ===== LTE BROADBAND CAPPED (11 PACKAGES) =====
  {
...
async function importConsumerPackages() {
  ...
  console.log(`📊 Total processed: ${consumerPackages.length}`);

  if (successCount > 0) {
    console.log('\n🎉 Consumer packages are now live on CircleTel!');
    console.log('Categories:');
    console.log('  - 5G Uncapped: 3 packages (R449-R949)');
    console.log('  - LTE Uncapped: 5 packages (R299-R699)');
    console.log('  - LTE Capped: 11 packages (R85-R649)');
  }
}
