...
// Read migration file
const migrationFile = path.join(__dirname, '..', 'supabase', 'migrations', '20251022000010_add_account_type_to_customers.sql');
...
async function applyMigration() {
  ...
  try {
    ...
    console.log('  Creating/replacing add account_type column function...\n');
