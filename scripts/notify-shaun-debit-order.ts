...
async function sendSMS() {
  ...
  const smsMessage = `Hi ${SHAUN.firstName}, your CircleTel invoice ${SHAUN.invoiceNumber} (R${SHAUN.amount.toFixed(2)}) will be debited on ${SHAUN.dueDate}. Questions? WhatsApp 084 773 9467.`;
