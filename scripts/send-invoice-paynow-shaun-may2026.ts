/**
 * Send May 2026 invoice Pay Now link to Shaun Robertson
 * Invoice: INV-2026-00008 | R899.00 | Due: 1 May 2026
 *
 * Run with: set -a && source .env.local && set +a && npx tsx scripts/send-invoice-paynow-shaun-may2026.ts
 */
...
const INVOICE = {
  id: '3a9a0644-d491-44fc-ba38-c9407ceff2e2',
