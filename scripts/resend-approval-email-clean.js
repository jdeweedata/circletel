...
async function resendApprovalEmail() {
  ...
  const fromEmail = 'noreply@notifications.circletelsa.co.za'; // Clean, verified domain
  ...
  console.log('\n📬 Check jdewee@live.com inbox (may take 10-30 seconds)');
  console.log('\n🔐 Temporary Password:', tempPassword);
  console.log('\n🌐 Login at: https://www.circletel.co.za/admin/login');
}
